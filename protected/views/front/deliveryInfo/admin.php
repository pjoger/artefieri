...
<h1><?php echo Yii::t('content', 'Manage DeliveryInfo');?></h1>
	...
	'columns'=>array(
		...
		array(
			...
			'value' => 'CHtml::dropDownList("delivery_status_".$data->id, '.
							'$data->status, array("0" => Yii::t("content","Pending"),"1"=>Yii::t("content","Processed"), "3" => Yii::t("content","Delivered"), "4" => Yii::t("content","Canceled"),'.
							'array('.
						...
						');',
			'htmlOptions'=>array('style'=>'text-align:center'),
			'filter' => array("0" => Yii::t("content","Pending"),"1"=>Yii::t("content","Processed"), "3" => Yii::t("content","Delivered"), "4" => Yii::t("content","Canceled")),
		),
		//'added',
		//'last_update',
		//'s_note_user',

	        ...
	        <div id="inner-right">
	        	<div class="pager-select">
	                <ul class="pager-pages">
	                	...
	                	<li class="item"><?php echo CHtml::link('<span>100</span>',array($this->uniqueid.'/'.$this->action->Id,'type'=>'limit', 'value'=>120, 'f' => urlencode(Yii::app()->params['filtre'])), array('class'=> $l==100 ? "selected" : " ") ); ?></li>
<?php /*

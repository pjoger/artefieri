...
class CurrencyController extends Controller
{
	...
	public function actionUpdateconversionrate(){
		...
		//redirect to admin
//  		$this->redirect(array('/currencyex/admin'));
		$this->render('../currencyex/admin',array(
				'model'=>new CurrencyEx('search'),
